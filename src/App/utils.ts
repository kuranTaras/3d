...
export const loadGltf = (url) =>
  new Promise((res, rej) => loader.load(url, (data) => res(data), undefined, rej));
export const loadHdri = (url) =>
  new Promise((res, rej) => new RGBELoader().load(url, (data) => res(data), undefined, rej));

export const createCamera = (aspect) =>
  new PerspectiveCamera(CAMERA_FOV, aspect, CAMERA_NEAR, CAMERA_FAR);
